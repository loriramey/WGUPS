...
class FileList(_FileList):
    ...
    """
    Process template line function.
...
class manifest_maker(sdist):
    ...
    """
     should suppress warning function.
...
def warn_depends_obsolete(cmd, basename, filename) -> None:
    ...
    """
    Warn depends obsolete function.
