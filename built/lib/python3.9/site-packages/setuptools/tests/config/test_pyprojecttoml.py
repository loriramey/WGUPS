...
def test_read_configuration(tmp_path):
    ...
    """
    Test read configuration function.
...
def test_discovered_package_dir_with_attr_directive_in_config(tmp_path, pkg_root, opts):
    ...
    """
    Test discovered package dir with attr directive in config function.
...
class TestEntryPoints:
    ...
    """
    Test all listed in dynamic function.
    ...
    """
    Test scripts not listed in dynamic function.
...
class TestClassifiers:
    ...
    """
    Test dynamic without config function.
    ...
    """
    Test dynamic readme from setup script args function.
    ...
    """
    Test dynamic without file function.
...
def test_ignore_unrelated_config(tmp_path, example):
    ...
    """
    Test ignore unrelated config function.
...
def test_include_package_data_by_default(tmp_path, config):
    ...
    """
    Test include package data by default function.
...
def test_include_package_data_in_setuppy(tmp_path):
    ...
    """
    Test include package data in setuppy function.
