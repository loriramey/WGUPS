...
class TestBuildMetaBackend:
    ...
    """
    Test get requires for build wheel function.
    ...
    """
    Test get requires for build sdist function.
    ...
    """
    Test build with existing file present function.
    ...
    """
    Test build with pyproject config function.
    ...
    """
    Test static metadata in pyproject config function.
    ...
    """
    Test prepare metadata for build wheel function.
    ...
    """
    Test prepare metadata inplace function.
    ...
    """
    Test build sdist explicit dist function.
    ...
    """
    Test build sdist version change function.
    ...
    """
    Test build sdist pyproject toml exists function.
    ...
    """
    Test build sdist setup py exists function.
    ...
    """
    Test build sdist setup py manifest excluded function.
    ...
    """
    Test build sdist builds targz even if zip indicated function.
    ...
    """
    Test build sdist relative path import function.
    ...
    """
    Test editable without config settings function.
    ...
    """
    Test build wheel inplace function.
    ...
    """
    Test editable with config settings function.
    ...
    """
    Test setup requires with auto discovery function.
    ...
    """
    Test dont install setup requires function.
    ...
    """
    Test sys argv passthrough function.
    ...
    """
    Test setup py file abspath function.
    ...
    """
    Test build with empty setuppy function.
...
def test_legacy_editable_install(venv, tmpdir, tmpdir_cwd):
    ...
    """
    Test legacy editable install function.
...
def test_sys_exit_0_in_setuppy(monkeypatch, tmp_path):
    ...
    """
    Test sys exit 0 in setuppy function.
...
def test_system_exit_in_setuppy(monkeypatch, tmp_path):
    ...
    """
    Test system exit in setuppy function.
