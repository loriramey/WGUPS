...
def test_dist_fetch_build_egg(tmpdir):
    ...
    """
    Test dist fetch build egg function.
...
def test_provides_extras_deterministic_order():
    ...
    """
    Test provides extras deterministic order function.
...
def test_check_package_data(package_data, expected_message):
    ...
    """
    Test check package data function.
...
def test_dist_default_py_modules(tmp_path, dist_name, py_module):
    ...
    """
    Test dist default py modules function.
...
def test_dist_default_packages(
    ...
    """
    Test dist default packages function.
...
def test_dist_default_name(tmp_path, dist_name, package_dir, package_files):
    ...
    """
    Test dist default name function.
