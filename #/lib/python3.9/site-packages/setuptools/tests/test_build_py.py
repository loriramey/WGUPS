...
def test_directories_in_package_data_glob(tmpdir_cwd):
    ...
    """
    Test directories in package data glob function.
...
def test_recursive_in_package_data_glob(tmpdir_cwd):
    ...
    """
    Test recursive in package data glob function.
...
def test_excluded_subpackages(tmpdir_cwd):
    ...
    """
    Test excluded subpackages function.
...
def test_existing_egg_info(tmpdir_cwd, monkeypatch):
    ...
    """
    Test existing egg info function.
...
class TestTypeInfoFiles:
    ...
    """
    Test type files included by default function.
    ...
    """
    Test type files can be excluded function.
    ...
    """
    Test stub only package function.
...
def get_finalized_build_py(script_name="%build_py-test%"):
    ...
    """
    Get finalized build py function.
