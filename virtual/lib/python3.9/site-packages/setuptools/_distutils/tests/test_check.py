...
class TestCheck(support.TempdirManager):
    ...
    """
    Test check author maintainer function.
    ...
    """
    Test check restructuredtext function.
    ...
    """
    Test check restructuredtext with syntax highlight function.
