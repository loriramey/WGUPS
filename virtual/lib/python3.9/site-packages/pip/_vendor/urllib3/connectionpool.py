...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    """
     is ssl error message from http proxy function.
...
def _close_pool_connections(pool):
    ...
    """
     close pool connections function.
