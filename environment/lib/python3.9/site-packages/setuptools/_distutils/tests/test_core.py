...
class TestCore:
    ...
    """
    Test run setup provides file function.
    ...
    """
    Test run setup preserves sys argv function.
    ...
    """
    Test run setup defines subclass function.
    ...
    """
    Test run setup uses current dir function.
    ...
    """
    Test run setup within if main function.
