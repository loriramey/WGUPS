...
def get_keyring_provider(provider: str) -> KeyRingBaseProvider:
    ...
    """
    Path as shutil which determines it function.
...
class MultiDomainBasicAuth(AuthBase):
    ...
    """
     get url and credentials function.
    ...
    """
     should save password to keyring function.
