...
class TestFindParentPackage:
    ...
    """
    Test multiple toplevel function.
...
class TestDiscoverPackagesAndPyModules:
    ...
    """
    Test purposefully empty function.
    ...
    """
    Test flat layout with extra files function.
    ...
    """
    Test flat layout with dangerous extra files function.
    ...
    """
    Test flat layout with single module function.
    ...
    """
    Test flat layout with multiple modules function.
    ...
    """
    Test py modules when wheel dir is cwd function.
...
class TestNoConfig:
    ...
    """
    Test build with discovered name function.
...
class TestWithAttrDirective:
    ...
    """
    Test setupcfg metadata function.
    ...
    """
    Test pyproject metadata function.
...
class TestWithCExtension:
    ...
    """
     simulate package with extension function.
    ...
    """
    Test skip discovery with setupcfg metadata function.
    ...
    """
    Test dont skip discovery with pyproject metadata function.
...
class TestWithPackageData:
    ...
    """
     simulate package with data files function.
    ...
    """
    Test include package data function.
...
def test_compatible_with_numpy_configuration(tmp_path):
    ...
    """
    Test compatible with numpy configuration function.
...
def test_name_discovery_doesnt_break_cli(tmpdir_cwd):
    ...
    """
    Test name discovery doesnt break cli function.
...
def test_preserve_explicit_name_with_dynamic_version(tmpdir_cwd, monkeypatch):
    ...
    """
    Test preserve explicit name with dynamic version function.
...
def _run_sdist_programatically(dist_path, attrs):
    ...
    """
     run sdist programatically function.
