...
class TestDistro:
    ...
    """
    Testinvalidincludeexclude function.
...
def test_findall_missing_symlink(tmpdir):
    ...
    """
    Test findall missing symlink function.
...
def test_its_own_wheel_does_not_contain_tests(setuptools_wheel):
    ...
    """
    Test its own wheel does not contain tests function.
...
def test_wheel_includes_cli_scripts(setuptools_wheel):
    ...
    """
    Test wheel includes cli scripts function.
...
def test_wheel_includes_vendored_metadata(setuptools_wheel):
    ...
    """
    Test wheel includes vendored metadata function.
