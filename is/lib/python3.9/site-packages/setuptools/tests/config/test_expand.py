...
class TestReadAttr:
    ...
    """
    Test read attr encoding cookie function.
    ...
    """
    Test read annotated attr function.
...
def test_fill_package_dir(tmp_path, files, where, expected_package_dir):
    ...
    """
    Test fill package dir function.
