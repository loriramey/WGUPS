...
class Distribution(metaclass=abc.ABCMeta):
    ...
    """
     read files egginfo installed function.
    ...
    """
     read files egginfo sources function.
    ...
    """
     deps from requires text function.
    ...
    """
     convert egg info reqs to simple reqs function.
...
def packages_distributions() -> Mapping[str, List[str]]:
    ...
    """
    Packages distributions function.
