...
def random_combination_with_replacement(iterable, r):
    ...
    """
    Random combination with replacement function.
...
def polynomial_from_roots(roots):
    ...
    """
    Polynomial from roots function.
