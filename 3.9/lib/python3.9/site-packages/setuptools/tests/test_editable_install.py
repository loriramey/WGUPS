...
def test_editable_with_pyproject(tmp_path, venv, files, editable_opts):
    ...
    """
    Test editable with pyproject function.
...
def test_editable_with_flat_layout(tmp_path, venv, editable_opts):
    ...
    """
    Test editable with flat layout function.
...
def test_editable_with_single_module(tmp_path, venv, editable_opts):
    ...
    """
    Test editable with single module function.
...
class TestLegacyNamespaces:
    ...
    """
    Test nspkg file is unique function.
    ...
    """
    Test namespace package importable function.
...
class TestPep420Namespaces:
    ...
    """
    Test namespace created via package dir function.
    ...
    """
    Test namespace accidental config in lenient mode function.
...
def test_editable_with_prefix(tmp_path, sample_project, editable_opts):
    ...
    """
    Test editable with prefix function.
...
class TestFinderTemplate:
    ...
    """
    Test combine namespaces function.
    ...
    """
    Test combine namespaces nested function.
    ...
    """
    Test dynamic path computation function.
    ...
    """
    Test namespace case sensitivity function.
    ...
    """
    Test intermediate packages function.
...
class TestOverallBehaviour:
    ...
    """
    Test editable install function.
...
class TestCustomBuildPy:
    ...
    """
    Test safeguarded from errors function.
...
class TestCustomBuildWheel:
    ...
    """
    Install custom build wheel function.
    ...
    """
    Test access plat name function.
...
class TestCustomBuildExt:
    ...
    """
    Install custom build ext distutils function.
    ...
    """
    Test distutils leave inplace files function.
